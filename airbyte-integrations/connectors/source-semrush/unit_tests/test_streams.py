...
import pytest
from source_semrush.source import SemrushStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(SemrushStream, "path", "v0/example_endpoint")
    mocker.patch.object(SemrushStream, "primary_key", "test_primary_key")
    mocker.patch.object(SemrushStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = SemrushStream()
